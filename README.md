...
🏀 Created **[Bronify](https://github.com/aminester/bronify)** - 7.8M+ site visits, recognized by LeBron James & LaVar Ball
...
Soccer • Travel • Urban Design • Running • Cycling • Music Production • Basketball
...
```javascript
const amine = {
    languages: ["Python", "JavaScript", "TypeScript", "Java", "Kotlin", "Swift", "C#", "Perl", "SQL", "R"],
    frontend: ["React", "Next.js", "Angular", "Vue", "HTML5", "CSS3", "Tailwind"],
    backend: ["Node.js", "Spring Boot", "Flask", "Django", ".NET"],
    mobile: ["Android (Kotlin)", "Swift", "React Native"],
    databases: ["PostgreSQL", "MySQL", "MongoDB", "MariaDB"],
    ml: ["TensorFlow", "PyTorch", "Pandas", "NumPy", "Scikit-learn"],
    tools: ["Docker", "Git", "Linux", "Figma", "Splunk", "Apache/Nginx"]
};
```
</details>
